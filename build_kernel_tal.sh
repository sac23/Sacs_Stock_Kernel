...
export INITRAMFS_SOURCE="${KERNELDIR}/../GS4_Ramdisk"
...
# Target Configs ...
export DREAM_DEFCONF=sac_defconfig
...
#
export ARCH=arm
export CROSS_COMPILE=/home/sac/GS4/toolchains/arm-4.7.4/bin/arm-galaxys4-linux-gnueabi-
...
## Build zImage
nice -n 10 make -j8 CC="ccache /home/sac/GS4/toolchains/arm-4.7.4/bin/arm-galaxys4-linux-gnueabi-gcc" zImage 2>&1 | tee compile-zImage.log
...
## Build Modules
nice -n 10 make -j8 CC="ccache /home/sac/GS4/toolchains/arm-4.7.4/bin/arm-galaxys4-linux-gnueabi-gcc" modules 2>&1 | tee compile-modules.log
